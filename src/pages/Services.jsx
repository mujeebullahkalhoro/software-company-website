...
// Importing images
import webdevImage from '../assets/services/webdev1.webp';
import mobileAppImage from '../assets/services/mbapp.webp';
import dataAnalysisImage from '../assets/services/dataanyalsis.webp';
import graphicDesignImage from '../assets/services/grahicdesign.webp';
import uiUxDesignImage from '../assets/services/uiuxdesign.png';
import videoAnimationImage from '../assets/services/videoanimation_processed.webp';
...
export default function Services() {
  ...
  return (
    <div className="services">
      <ServiceContainer image={webdevImage} heading="Web Development" text={webDevelopment} />
      <ServiceContainer image={mobileAppImage} heading="Mobile Development" text={mobileDevelopment} />
      <ServiceContainer image={dataAnalysisImage} heading="Data Analysis" text={dataAnalysis} />
      <ServiceContainer image={graphicDesignImage} heading="Graphics Design" text={graphicsDesign} />
      <ServiceContainer image={uiUxDesignImage} heading="UI/UX Design" text={uiUxDesign} />
      <ServiceContainer image={videoAnimationImage} heading="Video Animation" text={videoAnimation} />
    </div>
  );
}
